function Footer() {
  return (
    <div className="">
      <div className="border border-stone-400 p-7 lg:p-20 border-l-0 border-r-0 lg:flex lg:justify-around grid grid-cols-2 lg:gap-3 gap-6">
        <div>
          <h1 className="font-bold md:text-lg lg:py-3">SHOWROOM</h1>
          <p>
            2 Chome-3-4 Shibuya, Shibuya City, <br />
      ...
      <div className="lg:flex lg:justify-around grid grid-cols-2  items-center my-5 border border-stone-400 py-7 border-l-0 border-r-0 border-t-0">
        <img
          src="/footer1.png"
          alt="footer"
          className="lg:w-1/6 w-5/6 py-4 px-2"
        />
        <img
          src="/footer2.png"
          alt="footer"
          className="lg:w-1/5 w-5/6 py-4 px-2"
        />
        <img
          src="/footer3.png"
          alt="footer"
          className="lg:w-1/5 w-6/6 py-4 px-2 mx-32"
        />
      </div>

      <div className="md:flex px-2 gap-4 md:space-y-0 space-y-3 py-5 md:justify-between md:mx-24 md:px-10 ">
        ...
        <p>
          Copyright <b>@OluRemiFour</b>, Portfolio Project
        </p>
      </div>
    </div>
  );
