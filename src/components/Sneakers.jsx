...
function Sneakers() {
    const { dispatch, status, cartProduct, setCartProduct } = useContext(CartContext);
    ...
    const SneakersCategory = items.filter((item) => item.title === 'Sneakers')
  ...
  return (
    ...
    <div>
        ...
        {/* <div className='m-16'> */}
        <div>
            {/* <p className='lg:text-xl py-3 text-red-900 font-semibold border-b-2 border-dotted'>Sneakers</p> */}
              {SneakersCategory.map((item,i) => (
